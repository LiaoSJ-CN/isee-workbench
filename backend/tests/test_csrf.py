...
def test_post_with_whitelisted_origin_is_allowed(
...
def test_post_with_untrusted_origin_returns_403(
    client: TestClient, auth_headers: dict
) -> None:
...
def test_post_with_same_origin_is_allowed(
    client: TestClient, auth_headers: dict
) -> None:
...
def test_get_with_untrusted_origin_is_allowed(
    client: TestClient, auth_headers: dict
) -> None:
...
def test_metrics_endpoint_is_exempt(
    client: TestClient, auth_headers: dict
) -> None:
